...
public class DataHelper {
    ...
    public static CardInfo getInvalidCardInformation() {
        return new CardInfo("4444 4444 4444 4442", monthEndOfAction, yearEndOfAction, nameHolder,
                codeCvc);
    ...
    public static CardInfo getInvalidCardNumberIfEmpty() {
        return new CardInfo("", monthEndOfAction, yearEndOfAction, nameHolder,
                codeCvc);
    }
    ...
    public static CardInfo getInvalidCardNumberIfOutOfDatabase() {
        return new CardInfo("5578334444444441",monthEndOfAction, yearEndOfAction, nameHolder,
                codeCvc);
    }
    ...
    public static CardInfo getInvalidNumberOfMonthIfMore12() {
        return new CardInfo("4444 4444 4444 4441", "35", yearEndOfAction, nameHolder,
                codeCvc);
    }

    public static CardInfo getInvalidNumberOfMonthIfOneDigit() {
        return new CardInfo("4444 4444 4444 4441", "3", yearEndOfAction, nameHolder,
                codeCvc);
    }


    public static CardInfo getInvalidNumberOfMonthIfZero() {
        return new CardInfo("4444 4444 4444 4441", "00", yearEndOfAction, nameHolder,
                codeCvc);
    }

    public static CardInfo getInvalidYearIfZero() {
        return new CardInfo("4444 4444 4444 4441", monthEndOfAction, "00",
                nameHolder, codeCvc);
    }

    public static CardInfo getInvalidYearIfInTheFarFuture() {
        return new CardInfo("4444 4444 4444 4441", monthEndOfAction, "70",
                nameHolder, codeCvc);
    }

    public static CardInfo getInvalidNumberOfYearIfOneDigit() {
        return new CardInfo("4444 4444 4444 4441",  monthEndOfAction, "7",
                nameHolder, codeCvc);
    }

    public static CardInfo getInvalidYearIfEmpty() {
        return new CardInfo("4444 4444 4444 4441",  monthEndOfAction, "",
                nameHolder, codeCvc);
    }
